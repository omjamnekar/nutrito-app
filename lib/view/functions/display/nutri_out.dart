    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: DefaultTabController(
            ...
            child: FutureBuilder(
              future:
                  Future.value(nutritionalProvider.genNutrilizationResponse),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting ||
                  ...
                  final ratioData =
                      nutriFact?.ratioPromptManager!.ratioSpecified;
...
class HealthSection extends StatelessWidget {
  ...
  final List<HealthConsiderations>? healthData;
                  ...
                  children: [
                    ...
                    Text("Positive:",
                        style: GoogleFonts.poppins(
                            ...
                            color: const Color.fromARGB(221, 2, 121, 71))),
                    ...(item.positive ?? []).map((pos) => Text("+ $pos")),
                    Text(
                      "Negative:",
                      style: GoogleFonts.poppins(
                          fontWeight: FontWeight.w600,
                          color: const Color.fromARGB(221, 255, 122, 95)),
                    ),
                    ...(item.negative ?? []).map((neg) => Text("- $neg")),
                  ],
                ),
              ),
            );
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                            ...
                            child: Container(
                              ...
                              child: HealthScoreGraph(
                                ...
                                percentage: double.parse(
                                        conclusionData.overallHealthRating ??
                                            "0.0") *
                                    10,
                              ),
                            ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(conclusionData.allergenInformation?.toString() ??
                          "N/A"),
                    ],
                  ),
                ),
                ...
                _buildInfoRow(
                    "Allergens", initialData.allergenInformation ?? "N/A"),
                ...
                _buildInfoRow("Additional Info",
                    initialData.additionalInformation ?? "N/A"),
                ...
                Container(
                  child: FutureBuilder(
                    future: ctrl.suggestAlternative(
                        nutristate.genNutrilizationResponse
                    ...
                    builder: (BuildContext context,
                        AsyncSnapshot<List<AlthernativeModel>> snapshot) {
                      if (snapshot.data != null &&
                          snapshot.data![0].toJson().isNotEmpty &&
                          snapshot.connectionState == ConnectionState.done) {
                        print(snapshot.data![1].toJson());
                        return Container(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
